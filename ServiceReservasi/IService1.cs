...
namespace ServiceReservasi
{
    ...
    {
        [OperationContract]
        string pemesanan(string IDPemesanan, string NamaCustomer, string NoTelpon, int JumlahPemesanan, string IDLokasi);//proses input data
        [OperationContract]
        string editPemesanan(string IDPemesanan, string NamaCustomer, string No_telpon);
        [OperationContract]
        string deletePemesanan(string IDPemesanan);
        [OperationContract]
        List<CekLokasi> ReviewLokasi();//nampilin data yg ada di database (select all)
        [OperationContract]
        List<DetailLokasi> DetailLokasi();//nampilin detail lokasi
        [OperationContract]
    ...
    [DataContract]
    public class DetailLokasi //nampilin detail lokasi
    {
        [DataMember]
        public string IDLokasi { get; set; }
        [DataMember]
    ...
    public class Pemesanan
    {
        ...
        [DataMember]
        public string NoTelpom { get; set; }
        [DataMember]
